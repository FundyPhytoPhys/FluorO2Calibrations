...
O2SlopeData <- left_join(x = O2Data, y = FRRfDataLight, by = c("ObsDate", "CultureID" , "FileDateTime" = "StartDateTimeSol", "Ex_WL", "LR_s"), suffix = c("O2", "FRRf"), keep = FALSE)
...
Note: The first row always shows ActPARCorrinter with maximum PAR at ~ 800 LR_S despite the dataframe only containing zeros as it should. A glitch with ggplot??
...
```{r}
# generated 19 extra rows of data - Mireille to debug
O2FRRf <- O2Slopes %>%
  unnest(data) %>%
