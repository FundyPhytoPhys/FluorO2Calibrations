...
SolFitsTrim2 <- SolFitsTrim %>%
  ...
  mutate(aLHIIdark = (Fmdark * Fodark)/(Fmdark - Fodark), # uncalibrated estimate of absorbance serving PSII
         ...
         JVPSII_aLHIIminmax = ActPAR_photonsm2s * aLHIIminmax * FvFm, # uncal est of e L-1 s-1
         JVPSII_aLHIIdark = ActPAR_photonsm2s * aLHIIdark * FvFm,# uncal est of e L-1 s-1
         ETRC_WtTau = Sig_m2psii * C_WtTau * ActPAR_photonsm2s, # est e PSII-1 s-1 using fraction open PSII 
         ETRqp = Sig_m2psii * qp * ActPAR_photonsm2s, # est for e PSII -1 s-1 using fract PSII from double tap
        ETRqpOxbo = Sig_m2psii * qpOxbo * ActPAR_photonsm2s, # est e PSII-1 s-1 from Oxo algorithm
