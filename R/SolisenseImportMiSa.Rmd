...
SolFitsTrim2 <- SolFitsTrim %>%
  mutate(WtTau = ((Alp1QA * Tau1QA) + (Alp2QA * Tau2QA))/(Apl1QA + Alp2QA),
         InvWtTau = 1/WtTau,
         Sig_m2psii = Sig/1E20,
         ActPAR_photonsm2s = ActPAR *  6.022e17,
         ActPARCorr_photonsm2s = ActPARCorr *  6.022e17,
         C_WtTau = 1/(1 + (Sig_m2psii * ActPARCorr_photonsm2s * (WtTau /1000000)))
         ) %>%
  ...
  mutate(aLHIIdark = (Fmdark * Fodark)/(Fmdark - Fodark), # uncalibrated estimate of absorbance serving PSII
         ...
         ETRC_WtTau = Sig_m2psii * C_WtTau * ActPARCorr_photonsm2s, # est e PSII-1 s-1 using fraction open PSII 
        ...
        ETRqpOxbo = Sig_m2psii * qpOxbo * ActPARCorr_photonsm2s, # est e PSII-1 s-1 from Oxo algorithm
         JVPSII_ETRC_WtTau = ETRC_WtTau * Fomin/Sigmax, # est uncalibrated e L-1 s-1 
