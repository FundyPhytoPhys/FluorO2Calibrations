...
Something missing with TempCont
```{r prelimplot}
O2FRRfAll %>%
  filter(ActPARCorr != 0) %>%
  ggplot() +
  geom_point(aes(x = ActPARCorr, y = O2evln_O2ls, colour = as.factor(TempCont))) +
...
O2FRRfAll %>%
  ...
  geom_smooth(aes(x = ActPARCorr, y = ETRqpOxbo, colour = as.factor(TempCont)), method = "lm") +
  facet_grid(cols = vars(Ex_WL)) +
  theme_bw()
...
O2FRRfAll %>%
  filter(ActPARCorr != 0) %>%
  ggplot() +
  geom_point(aes(x = ETRqpOxbo, y = O2evln_O2ls * 4, colour = as.factor(Ex_WL), alpha = ActPARCorr)) +
  geom_smooth(aes(x = ETRqpOxbo, y = O2evln_O2ls * 4, colour = as.factor(Ex_WL)), method = "lm") +
...
O2FRRfAll %>%
  filter(ActPARCorr != 0) %>%
  ggplot() +
  geom_point(aes(x = O2evln_O2ls, y = JVPSII_ETRC_TauAv_FoSigmax_m2psii, colour = as.factor(Ex_WL), size = ActPARCorr)) +
  geom_smooth(aes(x = O2evln_O2ls, y = JVPSII_ETRC_TauAv_FoSigmax_m2psii, colour = as.factor(Ex_WL)), method = "lm") +
  scale_colour_manual(values = Colours_nm) +
  facet_grid(cols = vars(Ex_WL)) +
  #coord_fixed(ratio = 1) +
  theme_bw()
...
O2FRRfAll %>%
  filter(ActPARCorr != 0) %>%
  ggplot() +
  geom_point(aes(x = O2evln_O2ls, y = JVPSII_ETRC_TauAv_aLHIIOxboSigmax_m2psii, colour = as.factor(Ex_WL), size = ActPARCorr)) +
  geom_smooth(aes(x = O2evln_O2ls, y = JVPSII_ETRC_TauAv_aLHIIOxboSigmax_m2psii, colour = as.factor(Ex_WL)), method = "lm") +
  scale_colour_manual(values = Colours_nm) +
...
O2FRRfAll %>%
  filter(#Ex_WL == 445,
         ActPARCorr != 0) %>%
  ggplot() +
  geom_point(aes(x = O2evln_O2ls, y = JVPSII_aLHIIOxbomax, colour = as.factor(Ex_WL), size = ActPARCorr)) +
  geom_smooth(aes(x = O2evln_O2ls, y = JVPSII_aLHIIOxbomax, colour = as.factor(Ex_WL)), method = "lm") +
  scale_colour_manual(values = Colours_nm) +
  #facet_grid(rows = vars(Ex_WL)) +
  #coord_fixed(ratio = 1) +
  theme_bw()
...
O2FRRfPool %>%
  filter(ActPARCorr != 0,
         TempCont == "TC") %>%
  ggplot() +
  geom_point(aes(x = O2evln_O2ls/Chl_ugL_mean, y = JVPSII_aLHIIOxbomax/Chl_ugL_mean, colour = as.factor(TempCont), shape = strain)) +
  geom_smooth(aes(x = O2evln_O2ls/Chl_ugL_mean, y = JVPSII_aLHIIOxbomax/Chl_ugL_mean, colour = as.factor(TempCont)), method = "lm") +
  facet_grid(cols = vars(Ex_WL)) +
  theme_bw()
...
O2FRRfPool %>%
  filter(ActPARCorr != 0,
         TempCont == "TC") %>%
  ggplot() +
  geom_point(aes(x = O2evln_O2ls/Chl_ugL_mean, y = JVPSII_ETRC_TauAv_FoSigmax_m2psii/Chl_ugL_mean, colour = as.factor(TempCont), shape = strain)) +
  geom_smooth(aes(x = O2evln_O2ls/Chl_ugL_mean, y = JVPSII_ETRC_TauAv_FoSigmax_m2psii/Chl_ugL_mean, colour = as.factor(TempCont)), method = "lm") +
  facet_grid(cols = vars(Ex_WL)) +
  theme_bw()
...
O2FRRfPool %>%
  filter(ActPARCorr != 0,
         TempCont == "TC") %>%
  ggplot() +
  geom_point(aes(x = O2evln_O2ls/Chl_ugL_mean, y = JVPSII_ETRqpOxbo_FoSigmax_m2psii/Chl_ugL_mean, colour = as.factor(TempCont), shape = strain)) +
  geom_smooth(aes(x = O2evln_O2ls/Chl_ugL_mean, y = JVPSII_ETRqpOxbo_FoSigmax_m2psii/Chl_ugL_mean, colour = as.factor(TempCont)), method = "lm") +
  facet_grid(cols = vars(Ex_WL)) +
  theme_bw()
...
O2FRRfPool %>%
  filter(ActPARCorr != 0,
         TempCont == "TC") %>%
  ggplot() +
  geom_point(aes(x = O2evln_O2ls/Chl_ugL_mean, y = JVPSII_ETRC_TauAv_aLHIIOxboSigmax_m2psii/Chl_ugL_mean, colour = as.factor(TempCont), shape = strain)) +
  geom_smooth(aes(x = O2evln_O2ls/Chl_ugL_mean, y = JVPSII_ETRC_TauAv_aLHIIOxboSigmax_m2psii/Chl_ugL_mean, colour = as.factor(TempCont)), method = "lm") +
  facet_grid(cols = vars(Ex_WL)) +
  theme_bw()
...
O2FRRfPool %>%
  filter(ActPARCorr != 0,
         TempCont == "TC") %>%
  ggplot() +
  geom_point(aes(x = O2evln_O2ls/Chl_ugL_mean, y = JVPSII_ETRqpOxbo_aLHIIOxboSigmax_m2psii/Chl_ugL_mean, colour = as.factor(TempCont), shape = strain)) +
  geom_smooth(aes(x = O2evln_O2ls/Chl_ugL_mean, y = JVPSII_ETRqpOxbo_aLHIIOxboSigmax_m2psii/Chl_ugL_mean, colour = as.factor(TempCont)), method = "lm") +
  facet_grid(cols = vars(Ex_WL)) +
  theme_bw()
```
...
O2FRRfPool %>%
  ...
  ggplot() +
  geom_point(aes(x = O2evln_O2ls/Chl_ugL_mean * 4, y = ETRC_TauAv, colour = as.factor(Ex_WL), size = ActPARCorr)) +
  geom_smooth(aes(x = O2evln_O2ls/Chl_ugL_mean  * 4, y = ETRC_TauAv), method = "lm") +
  facet_grid(cols = vars(Ex_WL), rows = vars(CultureID, ObsDate)) +
  theme_bw()
...
#force linear models through 0 b/c we are excluding data where O2evln_O2ls <= 0 and at 0 PAR PSIIETR has to equal 0.
  ...
  mutate(O2ETRlm = map(O2ETRdata,  possibly(~ lm(O2evln_O2ls * 4 ~ 0 + ETRC_TauAv, data = .x), otherwise = NULL)),
...
# "JVPSII_aLHIIOxbomax"        "ETRC_TauAv"                 
#  [70] "ETRqpOxbo"                  "TestTauAvSat"               "ETRGorbo"                  
#  [73] "JVPSII_ETRC_TauAv_FoSigmax_m2psii"      "JVPSII_ETRqpOxbo_FoSigmax_m2psii"     "JVPSII_ETRC_TauAv_aLHIIOxboSigmax_m2psii" 
#  [76] "JVPSII_ETRqpOxbo_aLHIIOxboSigmax_m2psii"
...
O2FRRfPool %>%
  filter(
         ...
         #strain != "PCC6803") %>%
  ggplot() +
  geom_point(aes(x = JVPSII_ETRC_TauAv_FoSigmax_m2psii, y = O2evln_O2ls * 4, size = Chl_ugL_mean, colour = strain)) +
  geom_smooth(aes(x = JVPSII_ETRC_TauAv_FoSigmax_m2psii, y = O2evln_O2ls * 4, size = Chl_ugL_mean), method = "lm") +
 facet_grid(cols = vars(Ex_WL)) +
  theme_bw()
...
O2FRRfPool %>%
  filter(
         ...
         #strain != "PCC6803") %>%
  ggplot() +
  geom_point(aes(x = JVPSII_ETRqpOxbo_FoSigmax_m2psii, y = O2evln_O2ls * 4, size = Chl_ugL_mean, colour = strain)) +
  geom_smooth(aes(x = JVPSII_ETRqpOxbo_FoSigmax_m2psii, y = O2evln_O2ls * 4, size = Chl_ugL_mean), method = "lm") +
 facet_grid(cols = vars(Ex_WL)) +
  theme_bw()
...
O2FRRfPool %>%
  filter(
         ...
         #strain != "PCC6803") %>%
  ggplot() +
  geom_point(aes(x = JVPSII_ETRC_TauAv_aLHIIOxboSigmax_m2psii, y = O2evln_O2ls * 4, size = Chl_ugL_mean, colour = strain)) +
  geom_smooth(aes(x = JVPSII_ETRC_TauAv_aLHIIOxboSigmax_m2psii, y = O2evln_O2ls * 4, size = Chl_ugL_mean), method = "lm") +
 facet_grid(cols = vars(Ex_WL)) +
  theme_bw()
...
O2FRRfPool %>%
  filter(
         ...
         #strain != "PCC6803") %>%
  ggplot() +
  geom_point(aes(x = JVPSII_ETRqpOxbo_aLHIIOxboSigmax_m2psii, y = O2evln_O2ls * 4, size = Chl_ugL_mean, colour = strain)) +
  geom_smooth(aes(x = JVPSII_ETRqpOxbo_aLHIIOxboSigmax_m2psii, y = O2evln_O2ls * 4, size = Chl_ugL_mean), method = "lm") +
 facet_grid(cols = vars(Ex_WL)) +
  theme_bw()
