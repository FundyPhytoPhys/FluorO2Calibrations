...
O2FRRfMetaNest <-  O2FRRfMeta %>%
  ...
  JVPSII_ETRqpOxbo_FoSig_O2_param = map(JVPSII_ETRqpOxbo_FoSig_O2, possibly(glance, otherwise = NULL)),
    JVPSII_ETRqpOxbo_aLHII_Sig_O2 = map(data, possibly(~lm(JVPSII_ETRqpOxbo_aLHII_Sig ~ 0 + O2evln_O2ls, data = .x), otherwise = NULL)),
...
O2FRRfMetaNest %>%
  unnest(JVPSII_ETRqpOxbo_aLHII_Sig_O2_tidied)
