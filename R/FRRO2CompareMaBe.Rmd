...
O2FRRfMetaNest <-  O2FRRfMeta %>%
  ...
  JVPSII_ETRqpOxbo_FoSig_O2 = map(data, possibly(~lm(4 * O2evln_O2ls ~ 0 + JVPSII_ETRqpOxbo_FoSig , data = .x), otherwise = NULL)),
  ...
  JVPSII_ETRqpOxbo_FoSig_O2_param = map(JVPSII_ETRqpOxbo_FoSig_O2, possibly(glance, otherwise = NULL)),
    JVPSII_ETRqpOxbo_aLHII_Sig_O2 = map(data, possibly(~lm(4 * O2evln_O2ls ~ 0 + JVPSII_ETRqpOxbo_aLHII_Sig , data = .x), otherwise = NULL)),
...
O2FRRfMetaNest %>%
  ...
  geom_point(aes(x = JVPSII_ETRqpOxbo_FoSig, y = `4 * O2evln_O2ls`)) +
