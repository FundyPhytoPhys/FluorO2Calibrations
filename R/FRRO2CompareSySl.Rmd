...
O2FRRfMeta %>%
  filter(ActPARCorrinter > 0 & ActPARCorrinter < 200) %>%
  ggplot() +
  geom_point(aes(x = O2evln_O2ls, y = ETRCtauav, colour = Ex_WL, shape = Strain)) +
  scale_colour_manual(values = Colours_nm) +
  geom_smooth(aes(x = O2evln_O2ls, y = ETRCtauav, colour = Ex_WL), method = "lm") +
  #facet_grid(cols = vars(Strain)) +
  theme_bw()
...
O2FRRfMeta %>%
  filter(ActPARCorrinter > 0 & ActPARCorrinter < 200) %>%
  ggplot() +
  geom_point(aes(y  = (O2evln_O2ls * 4)/ETRCtauav, x = ActPARCorr, colour = Ex_WL, shape = Strain)) +
  scale_colour_manual(values = Colours_nm) +
  geom_smooth(aes(x = ActPARCorr, y =(O2evln_O2ls * 4)/ETRCtauav, colour = Ex_WL), method = "lm") +
  #facet_grid(cols = vars(Strain)) +
  scale_y_continuous(expand = c(0, 0), limits = c(0, NA)) +
  theme_bw()
...
O2FRRfMetaNest %>%
 ...
 #geom_line(aes(x = O2evln_O2ls, y = .fitted + .se.fit), colour = "grey", linetype = "dashed") +
 #geom_line(aes(x = O2evln_O2ls, y = .fitted - .se.fit), colour = "grey", linetype = "dashed") +
  geom_point(aes(x = O2evln_O2ls, y = JVPSII_ETRtauav_FoSig),colour = "darkgreen") +
  geom_point(aes(x = O2evln_O2ls, y = .resid), colour = "darkred", size = 0.1) +
  geom_hline(yintercept = 0,linetype = "dashed") +
  facet_grid(cols = vars(Ex_WL)) +
  theme_bw()
...
O2FRRfMetaNest %>%
 ...
 #geom_line(aes(x = O2evln_O2ls, y = .fitted + .se.fit), colour = "grey", linetype = "dashed") +
 #geom_line(aes(x = O2evln_O2ls, y = .fitted - .se.fit), colour = "grey", linetype = "dashed") +
  geom_point(aes(x = O2evln_O2ls, y =  JVPSII_ETRtauav_aLHII_Sig),colour = "darkgreen") +
  geom_point(aes(x = O2evln_O2ls, y = .resid), colour = "darkred", size = 0.1) +
  geom_hline(yintercept = 0,linetype = "dashed") +
  facet_grid(cols = vars(Ex_WL)) +
  theme_bw()
...
O2FRRfMetaNest %>%
 ...
 #geom_line(aes(x = O2evln_O2ls, y = .fitted + .se.fit), colour = "grey", linetype = "dashed") +
 #geom_line(aes(x = O2evln_O2ls, y = .fitted - .se.fit), colour = "grey", linetype = "dashed") +
  geom_point(aes(x = O2evln_O2ls, y =  JVPSII_ETRqpOxbo_aLHII_Sig),colour = "darkgreen") +
  geom_point(aes(x = O2evln_O2ls, y = .resid), colour = "darkred", size = 0.1) +
  geom_hline(yintercept = 0,linetype = "dashed") +
  facet_grid(cols = vars(Ex_WL)) +
  theme_bw()
