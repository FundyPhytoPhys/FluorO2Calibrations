...
```{r}
O2FRRfMeta <- left_join(x = FRRfData, y = O2Slopes, by = c("ObsDate", "CultureID", "Ex_WL", "GrowthLight", "ActPARCorr" = "ActPARCorrinter"), suffix = c("FRRf", "O2"), keep = FALSE) %>%
...
O2FRRfMeta %>%
  ...
  ggplot() + 
  geom_line(aes(x = ActPARCorr, y = O2evln_O2ls, colour = CultureID)) +
...
O2FRRfMetaNest <- O2FRRfMetaNest %>%
  select(-c(data, JVPSII_aLHIIOxbomax_O2, ETRCtauav_O2, ETRqpOxbo_O2, JVPSII_ETRtauav_FoSig_O2, JVPSII_ETRqpOxbo_FoSig_O2, JVPSII_ETRtauav_aLHII_Sig_O2))
```
