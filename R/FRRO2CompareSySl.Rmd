...
JVPSII_O2_ModelTerms <- O2FRRfMetaNest %>%
  select(-c("data", "JVPSII_ETRqpOxbo_FoSig_O2", "JVPSII_ETRqpOxbo_FoSig_O2_param", "JVPSII_ETRqpOxbo_FoSig_O2_predict")) |>
  unnest(c(JVPSII_ETRqpOxbo_FoSig_O2_tidied), names_sep = "_") |>
  ...
  pivot_wider(names_from = "JVPSII_ETRqpOxbo_FoSig_O2_tidied_term", values_from = c("estimate", "std.error", "p.value")) |>
  rename(Intercept = `estimate_(Intercept)`,
          Slope = `estimate_O2evln_O2ls`,
         Intercept_SE = `std.error_(Intercept)`,
         Slope_SE = `std.error_O2evln_O2ls`,
         Intercept_P = `p.value_(Intercept)`,
         Slope_P = `p.value_O2evln_O2ls`)
...
saveRDS(JVPSII_O2_ModelTerms, file.path(DataOut, paste(Project, Run, Cuvette, "JVPSII_O2_ModelTerms.Rds", sep = "_"), fsep = .Platform$file.sep))
...
#JVPSII O2 calibration to PicoBaltic
saveRDS(JVPSII_O2_ModelTerms, file.path("..", "..", "BalticPhotoperiod", "Data", "CleanedData", "JVPSIIO2Calib", "JVPSII_O2_ModelTerms.rds", fsep = .Platform$file.sep))
