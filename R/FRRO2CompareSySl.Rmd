...
MetaData <- MetaData %>%
  select(-c("Motivation", "Plate", "Well", "InocpH", "FinalpH", "Par_ueAdjusted", "DateOfAdjustment", "ElaspedHoursAtAdjustment" , "ExpEndDate", "...44",  "...45")) %>%
...
O2SlopeData <- left_join(x = O2Data, y = FRRfDataLight, by = c("ObsDate", "CultureID" , "Ex_WL", "GrowthLight","LR_s", "TempCont", "Project"), suffix = c("O2", "FRRf"), keep = FALSE)
...
O2Slopes <- O2SlopeDataClean %>%
  filter(!is.na(ActPARCorrinter)) %>%
    nest(O2data = -c(FilenameO2, ActPARCorrinter, CultureID, ObsDate, Ex_WL, GrowthLight, TempCont, Project, Run))
...
O2Slopes <- O2Slopes %>%
  ...
  group_by(FilenameO2, Run, Project, ObsDate, CultureID,  Ex_WL, GrowthLight, TempCont) %>% 
...
O2Slopes %>%
  ggplot() +
  geom_point(aes(x = ActPARCorrinter, y = O2evln_O2lsMIN, colour = Ex_WL)) +
  #geom_line(aes(x = ActPARCorrinter, y = O2evln_O2ls_OLD, colour = "black")) +
    scale_colour_manual(values = Colours_nm) +
facet_grid(cols = vars(Ex_WL), rows = vars(CultureID)) +
  theme(strip.text.y = element_text(size = 5, angle=0)) +
...
O2FRRfMeta <- left_join(x = O2FRRf, y = MetaData, by = c("CultureID" = "ID")) 
...
O2FRRfMeta %>%
  filter(ActPARCorrinter > 0 & ActPARCorrinter < 200) %>%
  ggplot() +
  geom_point(aes(x = O2evln_O2ls, y = ETRC_TauAv, colour = Ex_WL, shape = Strain)) +
  scale_colour_manual(values = Colours_nm) +
  geom_smooth(aes(x = O2evln_O2ls, y = ETRC_TauAv, colour = Ex_WL), method = "lm") +
  #facet_grid(cols = vars(Strain)) +
  theme_bw()
...
O2FRRfMeta %>%
  filter(ActPARCorrinter > 0 & ActPARCorrinter < 200) %>%
  ggplot() +
  geom_point(aes(x = O2evln_O2ls, y = ETRqpOxbo, colour = Ex_WL, shape = Strain)) +
  scale_colour_manual(values = Colours_nm) +
...
O2FRRfMeta %>%
  filter(ActPARCorrinter > 0 & ActPARCorrinter < 200) %>%
  ggplot() +
  geom_point(aes(x = O2evln_O2ls, y = JVPSII_ETRC_TauAv_FoSigmax_m2psii, colour = Ex_WL)) +
  scale_colour_manual(values = Colours_nm) +
  geom_smooth(aes(x = O2evln_O2ls, y = JVPSII_ETRC_TauAv_FoSigmax_m2psii, colour = Ex_WL), method = "lm") +
  #facet_grid(cols = vars(Strain)) +
  geom_vline(xintercept = 0, linetype = "dashed") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  theme_bw()
...
O2FRRfMeta %>%
  filter(ActPARCorrinter > 0 & ActPARCorrinter < 200) %>%
  ggplot() +
  geom_point(aes(x = O2evln_O2ls, y = JVPSII_ETRqpOxbo_FoSigmax_m2psii, colour = Ex_WL)) +
  scale_colour_manual(values = Colours_nm) +
  geom_smooth(aes(x = O2evln_O2ls, y = JVPSII_ETRqpOxbo_FoSigmax_m2psii, colour = Ex_WL), method = "lm") +
  #facet_grid(cols = vars(Strain)) +
  geom_vline(xintercept = 0, linetype = "dashed") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  theme_bw()
...
O2FRRfMeta %>%
  filter(ActPARCorrinter > 0 & ActPARCorrinter < 200) %>%
  ggplot() +
  geom_point(aes(x = O2evln_O2ls, y = JVPSII_ETRC_TauAv_aLHIIOxboSigmax_m2psii, colour = Ex_WL)) +
  scale_colour_manual(values = Colours_nm) +
  geom_smooth(aes(x = O2evln_O2ls, y = JVPSII_ETRC_TauAv_aLHIIOxboSigmax_m2psii, colour = Ex_WL), method = "lm") +
  #facet_grid(cols = vars(Strain)) +
  geom_vline(xintercept = 0, linetype = "dashed") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  theme_bw()
...
O2FRRfMeta %>%
  filter(ActPARCorrinter > 0 & ActPARCorrinter < 200) %>%
  ggplot() +
  geom_point(aes(x = O2evln_O2ls, y = JVPSII_ETRqpOxbo_aLHIIOxboSigmax_m2psii, colour = Ex_WL)) +
  scale_colour_manual(values = Colours_nm) +
  geom_smooth(aes(x = O2evln_O2ls, y = JVPSII_ETRqpOxbo_aLHIIOxboSigmax_m2psii, colour = Ex_WL), method = "lm") +
  #facet_grid(cols = vars(Strain)) +
  geom_vline(xintercept = 0, linetype = "dashed") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  theme_bw()
...
O2FRRfMeta %>%
  ...
  filter(Ex_WL == 470) |>
  ggplot() +
  geom_point(aes(y  = (O2evln_O2ls * 4)/ETRqpOxbo, x = ActPARCorr, colour = Ex_WL, shape = Strain)) +
  scale_colour_manual(values = Colours_nm) +
  geom_smooth(aes(x = ActPARCorr, y = (O2evln_O2ls * 4)/ETRqpOxbo, colour = Ex_WL), method = "lm") +
  #facet_grid(cols = vars(Strain)) +
...
O2FRRfMeta %>%
  filter(ActPARCorrinter > 0 & ActPARCorrinter < 200) %>%
  ggplot() +
  geom_point(aes(y  = (O2evln_O2ls * 4)/ETRC_TauAv, x = ActPARCorr, colour = Ex_WL, shape = Strain)) +
  scale_colour_manual(values = Colours_nm) +
  geom_smooth(aes(x = ActPARCorr, y =(O2evln_O2ls * 4)/ETRC_TauAv, colour = Ex_WL), method = "lm") +
  #facet_grid(cols = vars(Strain)) +
  scale_y_continuous(expand = c(0, 0), limits = c(0, NA)) +
  theme_bw()
...
O2FRRfMetaNest <-  O2FRRfMeta %>%
  ...
  # ETRC_TauAv_O2 = map(data, possibly(~lm(ETRC_TauAv ~ O2evln_O2ls, data = .x), otherwise = NULL)),
  # ETRC_TauAv_O2_tidied =  map(ETRC_TauAv_O2, possibly(tidy, otherwise = NULL)),
  # ETRC_TauAv_O2_param = map(ETRC_TauAv_O2, possibly(glance, otherwise = NULL)),
  # ETRC_TauAv_O2_predict =  map(ETRC_TauAv_O2, possibly(augment, otherwise = NULL)),
  ...
  JVPSII_ETRtauav_FoSig_O2 = map(data, possibly(~lm(JVPSII_ETRC_TauAv_FoSigmax_m2psii ~ O2evln_O2ls, data = .x), otherwise = NULL)),
  ...
  JVPSII_ETRtauav_FoSig_O2_predict =  map(JVPSII_ETRtauav_FoSig_O2, possibly(augment, otherwise = NULL)),
  JVPSII_ETRqpOxbo_FoSig_O2 = map(data, possibly(~lm(JVPSII_ETRqpOxbo_FoSigmax_m2psii ~ O2evln_O2ls, data = .x), otherwise = NULL)),
  ...
  JVPSII_ETRtauav_aLHII_Sig_O2 = map(data, possibly(~lm(JVPSII_ETRC_TauAv_aLHIIOxboSigmax_m2psii ~ O2evln_O2ls, data = .x), otherwise = NULL)),
  ...
  JVPSII_ETRtauav_aLHII_Sig_O2_predict =  map(JVPSII_ETRtauav_aLHII_Sig_O2, possibly(augment, otherwise = NULL)),
  JVPSII_ETRqpOxbo_aLHII_Sig_O2 = map(data, possibly(~lm(JVPSII_ETRqpOxbo_aLHIIOxboSigmax_m2psii ~ O2evln_O2ls, data = .x), otherwise = NULL)),
...
# O2FRRfMetaNest <- O2FRRfMetaNest %>%
#   select(-c(data, JVPSII_aLHIIOxbomax_O2, ETRqpOxbo_O2, JVPSII_ETRqpOxbo_FoSig_O2))

O2FRRfMetaModels <- O2FRRfMetaNest %>%
  select(-c("data", "JVPSII_aLHIIOxbomax_O2_tidied", "JVPSII_aLHIIOxbomax_O2_param", "JVPSII_aLHIIOxbomax_O2_predict", "JVPSII_ETRtauav_FoSig_O2_tidied", "JVPSII_ETRtauav_FoSig_O2_param", "JVPSII_ETRtauav_FoSig_O2_predict" ,  "JVPSII_ETRqpOxbo_FoSig_O2_tidied",      "JVPSII_ETRqpOxbo_FoSig_O2_param",  "JVPSII_ETRqpOxbo_FoSig_O2_predict" ,    
 "JVPSII_ETRtauav_aLHII_Sig_O2_tidied", "JVPSII_ETRtauav_aLHII_Sig_O2_param",     "JVPSII_ETRtauav_aLHII_Sig_O2_predict" , "JVPSII_ETRqpOxbo_aLHII_Sig_O2_tidied", "JVPSII_ETRqpOxbo_aLHII_Sig_O2_param", "JVPSII_ETRqpOxbo_aLHII_Sig_O2_predict" ))
```
...
O2FRRfMetaNest %>%
  unnest(JVPSII_ETRtauav_FoSig_O2_predict) %>%
  ggplot() +
  geom_line(aes(x = O2evln_O2ls, y = .fitted), colour = "black", linetype = "dashed") +
 #geom_line(aes(x = O2evln_O2ls, y = .fitted + .se.fit), colour = "grey", linetype = "dashed") +
 #geom_line(aes(x = O2evln_O2ls, y = .fitted - .se.fit), colour = "grey", linetype = "dashed") +
  geom_point(aes(x = O2evln_O2ls, y = JVPSII_ETRC_TauAv_FoSigmax_m2psii),colour = "darkgreen") +
  geom_point(aes(x = O2evln_O2ls, y = .resid), colour = "darkred", size = 0.1) +
  geom_hline(yintercept = 0,linetype = "dashed") +
  facet_grid(cols = vars(Ex_WL)) +
  theme_bw()
...
O2FRRfMetaNest %>%
 ...
 #geom_line(aes(x = O2evln_O2ls, y = .fitted + .se.fit), colour = "grey", linetype = "dashed") +
 #geom_line(aes(x = O2evln_O2ls, y = .fitted - .se.fit), colour = "grey", linetype = "dashed") +
  geom_point(aes(x = O2evln_O2ls, y =  JVPSII_ETRqpOxbo_FoSigmax_m2psii),colour = "darkgreen") +
  geom_point(aes(x = O2evln_O2ls, y = .resid), colour = "darkred", size = 0.1) +
  geom_hline(yintercept = 0,linetype = "dashed") +
  facet_grid(cols = vars(Ex_WL)) +
  theme_bw()
...
O2FRRfMetaNest %>%
  unnest(JVPSII_ETRtauav_aLHII_Sig_O2_predict) %>%
  ggplot() +
  geom_line(aes(x = O2evln_O2ls, y = .fitted), colour = "black", linetype = "dashed") +
 #geom_line(aes(x = O2evln_O2ls, y = .fitted + .se.fit), colour = "grey", linetype = "dashed") +
 #geom_line(aes(x = O2evln_O2ls, y = .fitted - .se.fit), colour = "grey", linetype = "dashed") +
  geom_point(aes(x = O2evln_O2ls, y =  JVPSII_ETRC_TauAv_aLHIIOxboSigmax_m2psii),colour = "darkgreen") +
  geom_point(aes(x = O2evln_O2ls, y = .resid), colour = "darkred", size = 0.1) +
  geom_hline(yintercept = 0,linetype = "dashed") +
  facet_grid(cols = vars(Ex_WL)) +
  theme_bw()
...
O2FRRfMetaNest %>%
  unnest(JVPSII_ETRqpOxbo_aLHII_Sig_O2_predict) %>%
  ggplot() +
  geom_line(aes(x = O2evln_O2ls, y = .fitted), colour = "black", linetype = "dashed") +
 #geom_line(aes(x = O2evln_O2ls, y = .fitted + .se.fit), colour = "grey", linetype = "dashed") +
 #geom_line(aes(x = O2evln_O2ls, y = .fitted - .se.fit), colour = "grey", linetype = "dashed") +
  geom_point(aes(x = O2evln_O2ls, y =  JVPSII_ETRqpOxbo_aLHIIOxboSigmax_m2psii),colour = "darkgreen") +
  geom_point(aes(x = O2evln_O2ls, y = .resid), colour = "darkred", size = 0.1) +
  geom_hline(yintercept = 0,linetype = "dashed") +
  facet_grid(cols = vars(Ex_WL)) +
  theme_bw()
...
```{r model terms}
JVPSII_O2_ModelTerms <- O2FRRfMetaNest %>%
  unnest(c( JVPSII_aLHIIOxbomax_O2_tidied, JVPSII_ETRtauav_FoSig_O2_tidied, JVPSII_ETRqpOxbo_FoSig_O2_tidied, JVPSII_ETRtauav_aLHII_Sig_O2_tidied, JVPSII_ETRqpOxbo_aLHII_Sig_O2_tidied), names_sep = "_") %>%
  select(-c("data", "JVPSII_ETRtauav_aLHII_Sig_O2",  "JVPSII_aLHIIOxbomax_O2", "JVPSII_aLHIIOxbomax_O2_param","JVPSII_aLHIIOxbomax_O2_predict","JVPSII_ETRtauav_FoSig_O2", "JVPSII_ETRtauav_FoSig_O2_param",        "JVPSII_ETRtauav_FoSig_O2_predict","JVPSII_ETRqpOxbo_FoSig_O2", "JVPSII_ETRqpOxbo_FoSig_O2_param","JVPSII_ETRqpOxbo_FoSig_O2_predict","JVPSII_ETRtauav_aLHII_Sig_O2_param","JVPSII_ETRtauav_aLHII_Sig_O2_predict",  "JVPSII_ETRqpOxbo_aLHII_Sig_O2","JVPSII_ETRqpOxbo_aLHII_Sig_O2_param","JVPSII_ETRqpOxbo_aLHII_Sig_O2_predict")) %>%
  select(-contains("_statistic")) %>%
  pivot_longer(cols = contains(c("estimate", "std.error", "p.value")), names_to = "ModelTerms") %>%
  select(-c("JVPSII_ETRtauav_FoSig_O2_tidied_term", "JVPSII_ETRqpOxbo_FoSig_O2_tidied_term", "JVPSII_ETRtauav_aLHII_Sig_O2_tidied_term", "JVPSII_ETRqpOxbo_aLHII_Sig_O2_tidied_term")) %>%
  rename(Term = JVPSII_aLHIIOxbomax_O2_tidied_term)


 JVPSII_O2_ModelTerms <- JVPSII_O2_ModelTerms %>%
   pivot_wider(values_from = "value",  names_from = "Term") %>%
   separate(col = ModelTerms, into = c("Model", "Term"), sep = "_O2_tidied_") %>%
   rename(Intercept = `(Intercept)`,
          Slope = `O2evln_O2ls`)
 
  JVPSII_O2_ModelTerms <- JVPSII_O2_ModelTerms %>%
   pivot_wider(names_from = "Term", values_from = c("Intercept", "Slope"))

JVPSII_O2_ModelTerms


JVPSII_O2_ModelParam <- O2FRRfMetaNest %>%
  unnest(c( JVPSII_aLHIIOxbomax_O2_param, JVPSII_ETRtauav_FoSig_O2_param, JVPSII_ETRqpOxbo_FoSig_O2_param, JVPSII_ETRtauav_aLHII_Sig_O2_param, JVPSII_ETRqpOxbo_aLHII_Sig_O2_param), names_sep = "_") %>%
  select(-c("data", "JVPSII_ETRtauav_aLHII_Sig_O2",  "JVPSII_aLHIIOxbomax_O2", "JVPSII_aLHIIOxbomax_O2_tidied","JVPSII_aLHIIOxbomax_O2_predict","JVPSII_ETRtauav_FoSig_O2", "JVPSII_ETRtauav_FoSig_O2_tidied",        "JVPSII_ETRtauav_FoSig_O2_predict","JVPSII_ETRqpOxbo_FoSig_O2", "JVPSII_ETRqpOxbo_FoSig_O2_tidied","JVPSII_ETRqpOxbo_FoSig_O2_predict","JVPSII_ETRtauav_aLHII_Sig_O2_tidied","JVPSII_ETRtauav_aLHII_Sig_O2_predict",  "JVPSII_ETRqpOxbo_aLHII_Sig_O2","JVPSII_ETRqpOxbo_aLHII_Sig_O2_tidied","JVPSII_ETRqpOxbo_aLHII_Sig_O2_predict")) %>%
  select(-contains(c("_statistic", "_logLik", "_BIC", "nobs", "deviance", "df.residual", "df", "sigma", "p.value"))) %>%
  pivot_longer(cols = contains(c("r.squared", "adj.r.squared", "AIC")), names_to = "ModelParam") %>%
    separate(col = ModelParam, into = c("Model", "Param"), sep = "_O2_param_") %>%
     pivot_wider(names_from = "Param", values_from = "value")

JVPSII_O2_ModelTermsParam <- left_join(JVPSII_O2_ModelTerms, JVPSII_O2_ModelParam, by = c("Ex_WL", "Model")) |>
  mutate(SESlope = Slope_std.error/Slope_estimate, .before = Slope_p.value)

JVPSII_O2_ModelTermsParam
...
saveRDS(JVPSII_O2_ModelTermsParam, file.path(DataOut, paste(Project, Run, Cuvette, "JVPSII_O2_ModelTermsParam.Rds", sep = "_"), fsep = .Platform$file.sep))
