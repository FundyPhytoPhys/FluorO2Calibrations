...
Ex_WL = 445 & SySl1158, SySl1159, SySl1191, SySl1192 (0 only) (ok in SolisenseImportSySl.Rmd)
 ...
 Currently O2Data 130431 obs; O2SlopeData 130728 obs; gaining ~300 rows somehow 
```{r leftjoin}
colnames(O2Data)

colnames(FRRfDataLight)

O2SlopeData <- left_join(x = O2Data, y = FRRfDataLight, by = c("ObsDate", "CultureID" , "Ex_WL", "GrowthLight","LR_s", "TempCont", "Project", "Run"), suffix = c("O2", "FRRf"), keep = FALSE)
